...
// that creates two 3/3 Phyrexian Wurm tokens. The real card splits
// deathtouch onto one and lifelink onto the other; token keywords
// are cosmetic in the sandbox, so both come from the shared
// PhyrexianWurmToken template (N: 2). Wurmcoil's own printed
