...
// smaller. Two of the five are in the roadmap's batch 06 (#299), a
// third in batch 10 (#303); the rest belong in this table when their
// batches reach them.
//
// No simplification.
func init() {
	for _, rock := range []struct{ oracleID, name, color string }{
		...
		// Roadmap batch 10 (#303).
		{"910488bf-66ab-415e-973b-1262b2ab7454", "Marble Diamond", "W"},
	} {
		Register(Spec{
