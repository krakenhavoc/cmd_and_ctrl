...
// them. Roadmap batch 11 (#304) ranks Iron Myr and Silver Myr; Gold,
// Leaden and Copper Myr belong in this table when their batches
// reach them. Palladium Myr ({T}: Add {C}{C}) is its own file.
//
