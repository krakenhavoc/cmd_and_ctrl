...
//   - "YOU put": nothing records who placed a counter, but counters
//     land during a resolution and the engine emits EventResolve —
//     with the resolving player as Actor — before it runs an item's
//     effect. b11ResolvingController reads that. A counter placed by
//     an opponent's effect (or by a sandbox hand-edit with no
//     resolution in flight) does not draw.
