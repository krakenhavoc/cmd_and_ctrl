...
//   - Fetched land enters UNTAPPED. Enters-tapped is S17.
//   - The dies-trigger is NOT wired in S14. Triggered-on-leave-
//     battlefield abilities require the listener pipeline that
//     lands in S19 (alongside Acidic Slime's target-at-ETB). The
//     OnETB hook is the only one available direct-call today.
func init() {
	Register(Spec{
