...
| Aang, Swift Savior (#325) | ~~Transform DFC; all five printings carry `card_faces`. Cannot be registered at all (ADR 0034 / #278).~~ **Half resolved (update 2026-09-16):** the multi-face model (#357, ADR 0034) imports him as his front face, a {1}{W}{U} 2/3, and `aang_swift_savior.go` registers him with caveats: flash, flying and the airbend ETB work. Transforming does not — there is no transform verb yet (#343), so "Waterbend {8}: Transform" and the back face's attack trigger are declared caveats. |
