...
- [ ] `internal/aiseat/decks/` implementing `aiseat.DeckSource` (sub-PR 4) — **three** decks that today's catalog actually supports: aggro, ramp-stompy, spell-based control
