...
- Replacement effects on discard (Library of Leng's "to top/bottom of library instead") — [S17](#s17--replacement-effects-engine-cr-614). *Corrected 2026-09-16:* Leng puts a card discarded by an **effect** on **top** of the library; it doesn't apply to costs or to this cleanup discard, and its controller has no maximum hand size. No discard reaches the replacement pipeline yet: [#650](https://github.com/krakenhavoc/cmd_and_ctrl/issues/650), after [#651](https://github.com/krakenhavoc/cmd_and_ctrl/issues/651). See [ADR 0013 §10a](decisions/0013-replacement-effects.md)
