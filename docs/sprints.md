...
| S24      | Equipment, auras, attachments                                        | 7     | [#76](https://github.com/krakenhavoc/cmd_and_ctrl/issues/76)   | 2027-04-18 | partial     |
...
- [ ] Theme-deck smoke test (equipment / voltron-adjacent deck plays 3 turns) — **not written**, and it has no issue of its own
...
**Status: partial** *(reconciled 2026-09-16, the #280 closeout)*. Every primitive and the card batch shipped, and #76 closed on 2026-09-14. But the theme-deck smoke test is unwritten, so by [the status legend](#how-to-read-the-status-column) the row is `partial`, as S30's was (#680). The tail:
...
- **The exit criterion**: the theme-deck smoke test above
